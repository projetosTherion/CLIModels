...
IPADAPTER_MODELS=(
    ...
    "https://drive.google.com/uc?id=1AmmLvOG1EXZlqnt8q-LBgapz44Lckpc7" #ip-adapter-plus_sdxl_vit-h.bin
...
function provisioning_download() {
    ...
    if [[ $url == *"drive.google.com"* ]]; then
        ...
        declare -A file_map=(
            ...
            ["1AmmLvOG1EXZlqnt8q-LBgapz44Lckpc7"]="ip-adapter-plus_sdxl_vit-h.bin"
